...
func TestBundleExecutable(t *testing.T) {
	for _, tc := range []struct {
		...
		{"/Applications/masseuse-camlink.app/Contents/MacOS/masseuse-camlink", true},
		{"/Users/me/Downloads/masseuse-camlink.app/Contents/MacOS/masseuse-camlink", true},
		{"/Users/me/Downloads/masseuse-camlink_0.7.0_darwin_arm64/masseuse-camlink", false},
		{"/Applications/masseuse-camlink.app/Contents/Helpers/ffmpeg", false},
...
func TestCommandScript(t *testing.T) {
	exe := "/Applications/masseuse-camlink.app/Contents/MacOS/masseuse-camlink"
	...
	want := `exec '/Applications/masseuse-camlink.app/Contents/MacOS/masseuse-camlink' -console -state-dir '/Users/o'\''brien/Library/Application Support/masseuse-camlink' "$@"` + "\n"
...
func TestCommandScriptRuns(t *testing.T) {
	...
	title := "\x1b]0;masseuse-camlink\a"
